...
HD_PWD='/thayerfs/home/f00436n/engs62/module3/module3/module3.runs/module3_hw_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log module3_hw_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source module3_hw_auto_pc_0.tcl
